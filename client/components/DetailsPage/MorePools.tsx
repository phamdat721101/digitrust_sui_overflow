  ...
  return (
    <div className="bg-[#FAFBFF] pb-20">
      <div className="container mx-auto">
        <h1 className="pt-[88px] pb-[42px] text-center text-4xl font-semibold capitalize leading-[150%] text-blue-600">
          More Pools
        </h1>
            ...
            <div key={data.vault_id}>
              <div className="space-y-2 rounded-[10px] border border-gray-45 px-3 py-4 shadow-cardMorePools">
                <div className="flex justify-between border-b border-gray-300 pb-2">
                  ...
                  ></Image>
                  <div>
                    <p className="text-right text-xs text-gray-500">Price</p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div>
                    <div className="flex items-center text-xl font-medium">
                      <p className="text-green-500">{data.monthly_return}</p>
                    </div>
                    <div className=" text-xs font-normal leading-[160%] text-gray-500">
                      MONTHLY
                    </div>
                  ...
                  <div>
                    <div className="flex items-center text-xl font-medium">
                      <p className="text-red-500">{data.daily_return}</p>
                    </div>
                    <div className=" text-xs font-normal leading-[160%] text-gray-500">
                      24H
                    </div>
                ...
                <div className="-ml-4 -mr-2">
                  <div className={`line-chart-${data.vault_id}`}></div>
                </div>
